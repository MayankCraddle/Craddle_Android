...
data class ProductListByTradeResponse(
	...
	val productList: List<ProductListItemByTrade?>? = null
)

data class MetaDataByTrade(
...
data class ProductListItemByTrade(
	...
	val metaData: MetaDataByTrade? = null,
