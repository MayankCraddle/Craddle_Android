...
public class PayStackPaymentActivity
    ...
    String paystack_public_key = "pk_test_1dfd4affcb0a1863c168a220cf8523d91c8ba7af";
    ...
    private static final String TAG = "PayStackPaymentActivity";
        ...
        mButtonPerformTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    PayStackPaymentActivity.this.mTextError.setText(String.format("An error occurred while charging card: %s %s", e.getClass().getSimpleName(), e.getMessage()));
    ...
    private void startAFreshCharge(boolean local) {
        ...
        dialog = new ProgressDialog(PayStackPaymentActivity.this);
        ...
        if (local) {
            ...
            charge.setAccessCode(getIntent().getStringExtra("accessCode"));
            chargeCard();
    ...
    private void chargeCard() {
        transaction = null;
        PaystackSdk.chargeCard(PayStackPaymentActivity.this, charge, new Paystack.TransactionCallback() {
            // This is called only after transaction is successful
            @Override
            public void onSuccess(Transaction transaction) {
                dismissDialog();
                String id=transaction.getReference();
                Log.e("transaction",transaction.toString());
                PayStackPaymentActivity.this.transaction = transaction;
                mTextError.setText(" ");
                Toast.makeText(PayStackPaymentActivity.this, transaction.getReference(), Toast.LENGTH_LONG).show();
                updateTextViews();
          ...
          /*  @Override
            public void showLoading(Boolean isProcessing) {
                ...
                if (isProcessing) {
                    Toast.makeText(PayStackPaymentActivity.this, "Processing...", Toast.LENGTH_LONG).show();
                }
            }*/
            ...
            public void onError(Throwable error, Transaction transaction) {
                ...
                if (error instanceof ExpiredAccessCodeException) {
                    PayStackPaymentActivity.this.startAFreshCharge(false);
                    PayStackPaymentActivity.this.chargeCard();
                    return;
                }
                ...
                if (transaction.getReference() != null) {
                    Toast.makeText(PayStackPaymentActivity.this, transaction.getReference() + " concluded with error: " + error.getMessage(), Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(PayStackPaymentActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private class fetchAccessCodeFromServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                PayStackPaymentActivity.this.mTextBackendMessage.setText(String.format("There was a problem getting a new access code form the backend: %s", error));
                dismissDialog();
            }
        }
    ...
    private class verifyOnServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
            if (result != null) {
                PayStackPaymentActivity.this.mTextBackendMessage.setText(String.format("Gateway response: %s", result));

            } else {
                PayStackPaymentActivity.this.mTextBackendMessage.setText(String.format("There was a problem verifying %s on the backend: %s ", this.reference, error));
                dismissDialog();
            }
        }
