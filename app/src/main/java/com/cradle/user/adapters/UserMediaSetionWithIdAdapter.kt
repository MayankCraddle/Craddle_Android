...
class UserMediaSetionWithIdAdapter (
    ...
    inner class MyViewHolder(private val mBinding: AdapterUserMediaProductBinding) :
        ...
        fun bind(contentListItem: ContentListItem, position: Int){
            ...
            if (contentListItem.type.equals("Product")) {
                ...
                mBinding.tvProductPrice.text = "$" + contentListItem.shortDescription
                ...
                if(contentListItem.shortDescription!!.length<=100){
                    ...
                    addReadMore(contentListItem.shortDescription.toString(),mBinding.tvMediaDis)
          ...
          val file=contentListItem.files
            ...
            try {
                ...
                if (contentListItem.videoId!!.isNotEmpty()){
                    ...
                    bannerList.add(videoUrl.toString())
                    adapter= SliderPagerAdapter(
                        ...
                        contentListItem.sectionId.toString(),"Video"
                    ,"")
            ...
            mBinding.tvViewAllComments.setOnClickListener {
                ...
                context.startActivity(Intent(context, CommentAllListActivity::class.java).putExtra("id",contentListItem.id.toString()).putExtra("subject","rahul"))
    ...
    interface SendCommit{
        fun bookSession(jsonObject: JsonObject)
    }
