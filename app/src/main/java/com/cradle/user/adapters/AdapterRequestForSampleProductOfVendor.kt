...
class AdapterRequestForSampleProductOfVendor (
    private val context: Context,
    private val productList: ArrayList<NewProductListOfVendorListItem?>?,private val  addItemInCart:AddItemToCart
) :
    RecyclerView.Adapter<AdapterRequestForSampleProductOfVendor.MyViewHolder>() {
        ...
        fun bind(list: NewProductListOfVendorListItem?, position: Int){
            ...
            mBinding.rlOpenAddtocart.setOnClickListener {
                if(list.orderable.equals("false")){
                    ...
                    addItemInCart.addDataToCart(list.itemId!!,MyConstants.REQUEST_FOR_SAMPLE_BY_VD_REQ_CODE)
