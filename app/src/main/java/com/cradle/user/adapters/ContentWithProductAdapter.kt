...
class ContentWithProductAdapter (
    private val context: Context
) :
    RecyclerView.Adapter<ContentWithProductAdapter.MyViewHolder>() {
  //  val listNew = ArrayList<ContentListItem>()
    var listNew: MutableList<ContentListItem?>? =  mutableListOf()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        try {
            val contentlist = listNew!![position]
    ...
    override fun getItemCount(): Int {
        return /*moviesList.size*/listNew!!.size;
    }
    ...
    fun setData(recipe: List<ContentListItem?>?) {
        recipe?.let { listNew!!.addAll(it) }
