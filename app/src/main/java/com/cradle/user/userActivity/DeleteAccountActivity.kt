...
import com.cradle.databinding.ActivityDeleteAccountBinding
...
class DeleteAccountActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AnalyticsUtils.analyticReport(this,MyConstants.DeletAccountScreen)
        findId()
    }
    ...
    private fun resultCount(){
        mainViewModel.getCardDetailsByIdParam(
                ...
                is ExceptionHandler.Success -> {
                    ...
                    try {
                        ...
                        if (it.data != null) {
                            ...
                            AnalyticsUtils.analyticReport(this,MyConstants.AccountDeleted)
                            mpref.clear()
